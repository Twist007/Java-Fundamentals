...
public class DragonTrap {
    ...
    public static void main(String[] args) {
        ...
        char[][] pernik = new char[rows][];
        char[][] originalPernik = new char[rows][];
        ...
        while (!command.equals("End")) {
            ...
            if (rotations != 0 && borders.length() > 0) {
                ...
                for (int i = 0; i < borders.length(); i++) {
                    ...
                    pernik[currentRow][currentCol] = currentChar;
                }
            }
    ...
    private static String rotateBorders(String borders, int rotations) {
        if (rotations < 0) {
            ...
            String rightPart = borders.substring(rotations);//vzima sichko do kraq ot rotations
